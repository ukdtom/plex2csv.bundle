...
def getMovieHeader(PrefsLevel):
	...
	if PrefsLevel.startswith('Special Level'):
		if PrefsLevel == 'Special Level 1':
			fieldnames = misc.getLevelFields(moviefields.SLevel_1, fieldnames)
		if PrefsLevel == 'Special Level 2':
			fieldnames = misc.getLevelFields(moviefields.SLevel_2, fieldnames)
		if PrefsLevel == 'Special Level 3':
			fieldnames = misc.getLevelFields(moviefields.SLevel_3, fieldnames)
		if PrefsLevel == 'Special Level 4':
			fieldnames = misc.getLevelFields(moviefields.SLevel_4, fieldnames)
		if PrefsLevel == 'Special Level 666':
			fieldnames = misc.getLevelFields(moviefields.SLevel_666, fieldnames)
		...
		return fieldnames
	# Level 1 fields
	fieldnames = misc.getLevelFields(moviefields.Level_1, fieldnames)		
	# Basic fields
	if PrefsLevel in ['Level 2','Level 3', 'Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
		fieldnames = misc.getLevelFields(moviefields.Level_2, fieldnames)		
	# Extended fields
	if PrefsLevel in ['Level 3', 'Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
		fieldnames = misc.getLevelFields(moviefields.Level_3, fieldnames)		
	# Extreme fields
	if PrefsLevel in ['Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
		fieldnames = misc.getLevelFields(moviefields.Level_4, fieldnames)
