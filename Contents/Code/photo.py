...
def getHeader(PrefsLevel):
	...
	if PrefsLevel.startswith('Special Level'):
		...
		if PrefsLevel == 'Special Level 666':
			fieldnames = misc.getLevelFields(photofields.SLevel_666, fieldnames)
		...
		return fieldnames
	# Level 1 fields
	fieldnames = misc.getLevelFields(photofields.Level_1, fieldnames)		
	# Basic fields
	if PrefsLevel in ['Level 2','Level 3', 'Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
		fieldnames = misc.getLevelFields(photofields.Level_2, fieldnames)		
	# Extended fields
	if PrefsLevel in ['Level 3', 'Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
		fieldnames = misc.getLevelFields(photofields.Level_3, fieldnames)		
	# Extreme fields
	if PrefsLevel in ['Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
		fieldnames = misc.getLevelFields(photofields.Level_4, fieldnames)
...
def getInfo(myMedia, myRow):
	...
	if 'Special' in prefsLevel:
		...
		# Get Basic Info
		if prefsLevel in ['Level 2','Level 3', 'Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
			myRow = misc.getItemInfo(myMedia, myRow, photofields.Level_2)
		# Get Extended Info
		if prefsLevel in ['Level 3', 'Level 4', 'Level 5', 'Level 6', 'Level 7', 'Level 8', 'Level 666']:
